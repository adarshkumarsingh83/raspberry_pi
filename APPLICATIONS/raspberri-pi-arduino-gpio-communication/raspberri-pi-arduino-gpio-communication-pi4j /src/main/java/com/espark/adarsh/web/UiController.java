...
public class UiController {
    ...
    public String lightLed(@PathVariable("name") String ledName, Model model) throws IOException, InterruptedException {
    ...
    public String offLed(@PathVariable("name") String ledName, Model model) throws IOException, InterruptedException {
