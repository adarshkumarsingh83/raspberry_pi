...
public class RestController {
    ...
    public String lightLed(@PathVariable("name") String ledName) throws IOException, InterruptedException {
        String message = this.communicationService.lightLed(ledName);
        return message;
    }

    @GetMapping(value = "/led-off/{name}")
    public String offLed(@PathVariable("name") String ledName) throws IOException, InterruptedException {
